...
\begin{titlepage}
    ...
    \vspace{12pt}
    {\fontsize{18}{1.5}\selectfont \textbf{Evaluation of University Admission Test Answer Scripts Through OCR-Based Answer Extraction and Rubric-Guided Assessment}}\\
    \vspace{12pt}
    \vspace{12pt}
...
\end{center}
    ...
    \justifying
    \begingroup
    The evaluation of descriptive university admission examination scripts is traditionally performed using manual paper-based procedures, requiring considerable time and administrative effort for script distribution, evaluation, moderation, and result preparation. As the number of admission applicants increases, these conventional methods become less efficient and make it difficult to ensure transparency, consistency, and timely publication of results. This project presents the design and implementation of a \textbf{Digital Admission Script Evaluation and Moderation System (DASEMS)}, a web-based platform developed to automate the complete admission script evaluation workflow.
    
    The proposed system integrates a React-based frontend, a Node.js and Express.js backend, a MongoDB database, and a Python-based document processing service. A hybrid PDF processing approach combining embedded text extraction and Optical Character Recognition (OCR) is used to detect question boundaries, extract question-wise answer regions, and generate structured metadata. The system also provides role-based access control, anonymous student identification, automated teacher assignment, browser-based digital evaluation, moderation support, and centralized result generation.
    
    The system was evaluated through functional testing and workflow validation using representative admission examination data. The results demonstrate that DASEMS successfully automates document processing, evaluation management, moderation, and reporting while maintaining secure access control and efficient communication among system components. By reducing manual administrative effort and introducing a transparent digital evaluation process, the proposed system improves the efficiency, reliability, and fairness of descriptive admission examination management. Its modular architecture also provides a foundation for future enhancements, including AI-assisted evaluation, handwriting recognition, and cloud-based deployment.
    \endgroup
...
\include{Proposed Methodology and System Design}
\include{Implementation}
\include{Result and Discussion}
\include{Conclusions}
